import type { Factory } from '../../../dashboard/entities/factory/model/types'
import type { Location } from '../../../dashboard/entities/location/model/types'
import type { LidarSensor } from '../../../dashboard/entities/lidar-sensor/model/types'
import type {
  AssemblyPlanInfo,
  LidarBlockInfo,
  LidarBlockTransform,
  LidarHistoryEvent,
  SubAssemblyStatus,
} from '../../../dashboard/entities/lidar-block/model/types'
import type { BlockAssemblyEntry, LoadedBlockModel } from '../../../dashboard/entities/block-model/model/types'
import { loadBlockManifest, loadBlockModel } from '../../../dashboard/entities/block-model/api/loadBlockModel'
import { restExtents } from '../../../dashboard/entities/block-model/model/types'
import type {
  FactoryBaySummary,
  FactoryOverview,
} from '../../../dashboard/features/factory-monitoring/model/types'
import { BAY_WIDTH } from '../../../dashboard/features/pointcloud-viewer/lib/bayConfig'
import {
  mockFactories,
  mockLocations,
  mockLidarSensors,
