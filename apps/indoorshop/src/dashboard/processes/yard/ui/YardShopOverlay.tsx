    ...
    >
      ...
      <div className="flex items-stretch gap-px p-1.5">
        <Link
          to={bayHref}
          className={cn(
            'flex min-h-7 flex-1 items-center justify-center rounded-inshop-sm bg-glass-active px-2 text-2xs font-medium',
            'text-glass-foreground transition-colors hover:bg-glass-active',
            'focus:outline-none focus-visible:ring-2 focus-visible:ring-glass-accent',
          )}
        >
        ...
        <Link
          ...
          className={cn(
            ...
            'text-glass-foreground/68 transition-colors hover:bg-glass-hover hover:text-glass-foreground',
            'focus:outline-none focus-visible:ring-2 focus-visible:ring-glass-accent',
          )}
        >
