...
export function ViewportFullscreenButton({
  ...
  const label = isFullscreen ? t('viewer.fullscreenExit') : t('viewer.fullscreenEnter')
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'text-glass-foreground/68 transition-colors hover:bg-white/12 hover:text-glass-accent',
