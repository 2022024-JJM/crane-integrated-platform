...
import type { LatLon, YardBlock, YardLot, YardMove, YardPlan } from '../../../entities/yard/model/types'
import { quadContains } from '../../../entities/yard/model/types'
import { colorOfCategory, yardExtent } from '../../../entities/yard/api/yardRepository'
...
export function YardMap({
  ...
  useEffect(() => {
    ...
    const onPointerMove = (event: PointerEvent) => {
      ...
      setCursor(block || bay || pickMove(sx, sy) !== null ? 'pointer' : 'grab')
