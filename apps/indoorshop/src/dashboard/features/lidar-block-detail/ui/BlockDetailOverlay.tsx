...
import {
  ...
  parseWstgCode,
  isSpecialSeries,
} from '../../../entities/lidar-block/model/types'
import { detectionProgress, hasProgressData } from '../../pointcloud-viewer/lib/progressStatus'
    ...
    >
      ...
      {hasProgressData(block) && (
        <div className="border-b border-glass-border/70 px-2.5 py-2">
          ...
          <div className="mt-1 h-1 w-full overflow-hidden rounded-full bg-white/12">
            <div
