...
export const en: Resources = {
  ...
  dashboard: {
    ...
    map: {
      ...
      perfBadge: {
        ...
        judgedCount: 'Recognized {{done}}/{{total}}',
        note: 'Reference figure: assembly recognition ÷ planned denominator — not an official KPI. Click to open Performance.',
  ...
  performance: {
    ...
    header: {
      ...
      unmatchedTitle: 'Recognized here, absent in legacy — completion forbidden, alert pending',
    ...
    asm: {
      ...
      counting: 'Recognized (denominator: planned REQ_QTY · reference)',
      countingPending: 'Real recognition counts arrive with OT auto-collection — deterministic mock for now',
      judgeStatus: { complete: 'Judged complete', partial: 'Partly recognized', none: 'Not recognized' },
      ...
      matchStateNote: {
        ...
        unmatched: 'Recognized here, absent in legacy — completion forbidden, raises a missing-item alert (ASM-F10)',
      },
      ...
      selfRateNote: 'ASSY-only rate = recognized ÷ planned (REQ_QTY)',
