...
export const en: Resources = {
  ...
  dashboard: {
    ...
    map: {
      ...
      blockSearchPlaceholder: 'Search hull-block · e.g. 7004-222',
  ...
  performance: {
    ...
    stages: {
      ...
      nodeNote: 'Only the 5 stages with a completion source are counted — sorting, pre-treatment and final issue are not collection nodes',
  ...
  viewer: {
    ...
    firstRun: {
      hint: 'Shift or right-drag to orbit · left-drag to pan · click then wheel to zoom · click a bay label to select',
