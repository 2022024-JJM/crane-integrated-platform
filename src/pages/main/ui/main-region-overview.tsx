...
export function MainRegionOverview({ regions }: MainRegionOverviewProps) {
  return (
    <>
      <div className="flex items-center gap-3 mb-[18px] px-[clamp(20px,4vw,40px)] text-[13px] text-[var(--main-page-text-dim)] uppercase tracking-[0.14em] before:content-[''] before:w-0.75 before:h-3.5 before:rounded-full before:bg-[var(--main-page-accent)] after:content-[''] after:flex-1 after:h-px after:bg-[var(--main-page-border)]">
        {TEXT.sectionLabel}
      </div>
