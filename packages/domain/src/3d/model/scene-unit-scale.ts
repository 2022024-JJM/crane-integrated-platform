 ...
 * 졌는지에 따라 다르다: 옥포 씬(1dock·2dock·dock-in)은 모델 스케일·위치가
 * 11.7 m/unit 축소 축척으로 놓여 있고, 필리 두 씬은 지도·모델이 미터 단위
 * (philly-area 폭 2391 unit = 2391 m, LNGC 174K 선박 약 300 unit)라 1 m/unit.
 * 옥포 지도(okpo.glb)는 미터 단위라 씬 배치와 축척이 어긋나 있다 — 1dock·
 * 2dock 의 모델·카메라를 미터 축척으로 다시 놓을 때 그 region 을 1 로 바꾼다.
 *
