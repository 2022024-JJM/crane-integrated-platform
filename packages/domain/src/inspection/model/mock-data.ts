...
const CRANE_POOL: Array<{ craneId: string; craneName: string; siteId: string; siteName: string }> = [
  { craneId: 'crane-660t', craneName: '660T Goliath Crane', siteId: 'dock-1', siteName: 'Dock No.1' },
  { craneId: 'crane-50t', craneName: '50T East Luffing Crane', siteId: 'dock-2', siteName: 'Dock No.2' },
];
