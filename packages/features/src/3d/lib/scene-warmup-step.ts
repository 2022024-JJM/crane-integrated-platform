import type { BvhBuildSnapshot } from '@crane/domain/3d';
 ...
 *
 *  1. bvh       — 전역 BVH 큐에 미빌드 지오메트리가 남아 있음(CPU 정지의 주범)
 *  2. collision — 충돌 감지 런타임이 기준선 단계(BVH 완료 직후 몇 틱)
 *  3. assets    — three DefaultLoadingManager 가 활성(다운로드·파싱 중). 가장
